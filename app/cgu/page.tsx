    ...
    <main className="min-h-screen bg-slate-50 p-6 sm:p-8">
      <div className="mx-auto max-w-2xl rounded-xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <div className="mt-6 space-y-6 text-sm leading-relaxed text-slate-700">
          ...
          <section>
            <h2 className="font-semibold text-slate-900">2. Description du service</h2>
            <p className="mt-1">
          ...
          <section>
            <h2 className="font-semibold text-slate-900">3. Statut du service</h2>
            <p className="mt-1">
          ...
          <section>
            <h2 className="font-semibold text-slate-900">4. Inscription et comptes</h2>
            <p className="mt-1">
          ...
          <section>
            <h2 className="font-semibold text-slate-900">5. Résiliation</h2>
            <p className="mt-1">Chaque partie peut résilier à tout moment.</p>
          </section>

          <section>
            <h2 className="font-semibold text-slate-900">6. Droit applicable</h2>
