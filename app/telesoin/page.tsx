      ...
      <div className="mx-auto max-w-2xl">
        ...
        {kinePro && (
          <section className="mt-6">
            <h2 className="text-lg font-medium text-slate-900">Démarrer un appel</h2>
            {patients.length === 0 ? (
          ...
          <section className="mt-6">
            ...
            {activeCalls.length === 0 ? (
              <p className="mt-2 text-sm text-slate-500">
                Aucun appel en cours. Quand votre kiné démarre une consultation, un bouton pour la
                rejoindre apparaîtra ici.
              </p>
            ) : (
              <ul className="mt-3 space-y-2">
                {activeCalls.map((c) => (
