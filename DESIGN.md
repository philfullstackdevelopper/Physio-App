...
- The « Tarif & paiements » page (`/dashboard/facturation`) was retokened on 2026-09-04 when its content was redesigned (simulator, reassurance rows, how-it-works strip); it now uses the same app palette as the rest of the dashboard.
