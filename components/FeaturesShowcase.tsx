...
const JOURNEY = [
  {
    ...
    exercises: ["Chat-vache", "Pont fessier", "Gainage abdominal (planche)"],
    attendance: 60,
  },
  {
    week: 2,
  ...
  },
  {
    ...
    exercises: ["Pont fessier", "Squat contre un mur", "Planche latérale"],
    attendance: 75,
  },
  {
    week: 4,
  ...
  },
  {
    ...
    exercises: ["Squat", "Pont fessier", "Planche latérale"],
    attendance: 91,
  },
  {
    week: 7,
